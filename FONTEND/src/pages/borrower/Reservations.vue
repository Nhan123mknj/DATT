<template>
  <div class="space-y-6 max-w-7xl mx-auto">
    ...
    <Modal
      ...
      size="2xl"
    >
      <div v-if="selectedReservation" class="text-sm text-gray-700">
        <div
          class="grid grid-cols-1 gap-6"
          :class="{ 'lg:grid-cols-2': selectedReservation.commitment_file }"
        >
          <div class="space-y-5">
            <div
            ...
            <div class="sticky top-0">
              ...
              <div class="space-y-3">
                <div
                  ...
                  class="rounded-lg overflow-hidden border border-blue-200 bg-white h-[600px]"
                >
                  <embed
                    :src="getFileUrl(selectedReservation.commitment_file)"
                ...
                >
                  ...
                  <a
                    :href="getFileUrl(selectedReservation.commitment_file)"
                    target="_blank"
