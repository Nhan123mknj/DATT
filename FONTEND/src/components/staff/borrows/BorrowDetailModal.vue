  ...
  >
    <div v-if="borrow" class="text-sm text-gray-700">
      <div
        ...
        :class="{ 'lg:grid-cols-2': borrow.commitment_file }"
      >
        <div class="space-y-5">
          ...
          <div class="bg-indigo-50 border border-indigo-100 rounded-xl p-4">
            ...
            <div class="grid grid-cols-1 gap-3">
              ...
              <div v-if="borrow.created_by">
                <p class="text-gray-500 text-xs mb-1">Người tạo phiếu</p>
                <p class="font-medium text-gray-900">
                  {{ borrow.created_by?.name }}
                </p>
                <p class="text-xs text-blue-700 truncate">
              ...
              <div v-if="borrow.issued_by">
                <p class="text-gray-500 text-xs mb-1">Người xuất kho</p>
                <p class="font-medium text-gray-900">
                  {{ borrow.issued_by?.name }}
                </p>
                <p class="text-xs text-blue-700 truncate">
                  {{ borrow.issued_by.email }}
                </p>
              </div>
            </div>
          </div>
